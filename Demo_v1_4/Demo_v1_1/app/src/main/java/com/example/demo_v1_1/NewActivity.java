                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < c; i++) {
                            ...
                            spinnerDialog=new SpinnerDialog(NewActivity.this,items,"Doktor Seç veya Ara","Kapat");// With No Animation
                            spinnerDialog=new SpinnerDialog(NewActivity.this,items,"Doktor Seç veya Ara",R.style.DialogAnimations_SmileWindow,"Kapat");// With 	Animation
                            ...
                            spinnerDialog.bindOnSpinerListener(new OnSpinerItemClick() {
                                ...
                                public void onClick(String item, int position) {
                                    Intent intent3 = new Intent(NewActivity.this,PrescriptionActivity.class);
                                    intent3.putExtra("id",String.valueOf(columnName3));
